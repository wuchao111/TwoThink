...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '(pQ{amu3?Vx<jlHZ:.=&N@fTs9/BEG*Y4>M`nhSe', //默认数据加密KEY
	'data_cache_key'=> '(pQ{amu3?Vx<jlHZ:.=&N@fTs9/BEG*Y4>M`nhSe',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'(pQ{amu3?Vx<jlHZ:.=&N@fTs9/BEG*Y4>M`nhSe', //加密KEY
