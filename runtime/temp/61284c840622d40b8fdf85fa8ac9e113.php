    ...
    <div class="container-fluid">
        <form action="<?php echo url('add'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img src="<?=$notice['pic']?>" alt="" width="50px" height="50px">
            </div>
            <div class="form-group">
                <label>内容:</label>
