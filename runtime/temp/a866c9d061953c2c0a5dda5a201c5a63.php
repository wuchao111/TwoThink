...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('edit'); ?>" method="post">
            ...
            <div class="form-group">
                <label>开始时间:</label>
                <input type="date" class="form-control" name="start_time" value="<?php echo $row['statr_time']; ?>"/>
            </div>
            <div class="form-group">
                <label>结束时间:</label>
                <input type="date" class="form-control" name="end_time" value="<?php echo $row['endsss_time']; ?>"/>
            </div>
            <div class="form-group">
                <label>发布:</label><input type="radio"  name="status" value="1" />
                <label>不发布:</label><input type="radio"  name="status" value="2"/>
            </div>
            <!--<div class="form-group">-->
