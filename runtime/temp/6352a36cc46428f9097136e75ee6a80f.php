...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('add'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>发布:</label><input type="radio"  name="status" value="1" checked="checked"/>
