    ...
    <div class="col-xs-12">
        ...
        <div class="table-responsive margin-top-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    <td><img src="<?=$activity['pic']?>" alt="" width="50px" height="50px"></td>
                    <td><?=$activity['title']?></td>
                    <td><?=$activity['content']?></td>
                    <td><?=$activity['start_time']?></td>
                    <td><?=$activity['end_time']?></td>
                    <td><?=$activity['status']==1 ? '处理' : '未处理'?></td>
                    <td>
                        <a href="<?php echo url('del'); ?>?id=<?=$activity['id']?>">删除</a>
                        <a href="<?php echo url('edit'); ?>?id=<?=$activity['id']?>">修改</a>
                    </td>
                </tr>
                <?php endforeach;?>
            </table>
