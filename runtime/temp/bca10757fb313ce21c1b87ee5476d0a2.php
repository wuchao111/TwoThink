...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('edit'); ?>" method="post">
            ...
            <div class="form-group">
                <label>标题:</label>
                <input type="text" class="form-control" name="titel" value="<?php echo $row['0']['titel']; ?>"/>
            </div>
            <div class="form-group">
                <label>内容:</label>
                <input type="text" class="form-control" name="content" value="<?php echo $row['0']['content']; ?>"/>
            </div>
