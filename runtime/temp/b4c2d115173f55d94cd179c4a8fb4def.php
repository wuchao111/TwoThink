        ...
        <div class="table-responsive margin-top-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    <td><?=$notice['name']?></td>
                    <td><?=$notice['title']?></td>
                    <td><?=date('Y-m-d H:i:s',$notice['time'])?></td>
                    <td><?=$notice['intro']?></td>
                    <td><img src="<?=$notice['pic']?>" alt="" width="50px" height="50px"></td>
                    <td>
                        <a href="<?php echo url('del'); ?>?id=<?=$notice['id']?>">删除</a>
                        <a href="<?php echo url('edit'); ?>?id=<?=$notice['id']?>">修改</a>
                    </td>
                </tr>
                <?php endforeach;?>
            </table>
