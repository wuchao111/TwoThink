    ...
    <div class="col-xs-12">
        ...
        <div class="table-responsive margin-top-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <?php foreach ($busin as $bus):?>
                <tr>
                    <td><img src="<?=$bus['pic']?>" alt="" width="50px" height="50px"></td>
                    <td><?=$bus['name']?></td>
                    <td><?=$bus['title']?></td>
                    <td><?=$bus['content']?></td>
                    <td><?=$bus['start_time']?></td>
                    <td><?=$bus['end_time']?></td>
                    <td><?=$bus['status']==1 ? '处理' : '未处理'?></td>
                    <td>
                        <a href="<?php echo url('del'); ?>?id=<?=$bus['id']?>">删除</a>
                        <a href="<?php echo url('edit'); ?>?id=<?=$bus['id']?>">修改</a>
                    </td>
                </tr>
                <?php endforeach;?>
            </table>
