<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\www\TwoThink\public/../application/home/view/default/index\fuwu.html";i:1521943182;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <ul class="list-group fuwuList">
                <li class="list-group-item"><a href="<?php echo url('diaocha'); ?>" class="text-danger"><span class="iconfont">&#xe604;</span>调查问卷</a> </li>
                <li class="list-group-item"><a href="<?php echo url('yezhu'); ?>" class="text-info"><span class="iconfont">&#xe605;</span>业主认证</a></li>
