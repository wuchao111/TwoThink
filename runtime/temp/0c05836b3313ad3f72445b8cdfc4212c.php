...
<div class="row">
    <div class="col-xs-12">
        <div>
            <div href="<?php echo url('add'); ?>" class="ajax-get iframe btn btn-sm bg-green"><i class="fa fa-fw fa-plus"></i>添加</div>
        </div>
        <!-- 数据列表 -->
        <div class="table-responsive margin-top-5">
            <table class="table table-bordered table-striped table-hover">
                ...
                <?php foreach ($propertys as $propertry):?>
                <tr>
                <td><?=$propertry['name']?></td>
                <td><?=$propertry['tel']?></td>
                <td><?=$propertry['titel']?></td>
                <td><?=$propertry['address']?></td>
                <td><?=$propertry['content']?></td>
                <td><?=date('Y-m-d H:i:s',$propertry['time'])?></td>
                <td><?=$propertry['status']==1 ? '未处理': '已处理'?></td>
                <td>
                    <a href="<?php echo url('del'); ?>?id=<?=$propertry['id']?>">删除</a>
                    <a href="<?php echo url('edit'); ?>?id=<?=$propertry['id']?>">修改</a>
                </td>
                </tr>
                <?php endforeach;?>
            </table>
