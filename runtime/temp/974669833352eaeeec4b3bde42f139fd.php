    ...
    <div class="container-fluid">
        <form action="<?php echo url('edit'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img src="<?php echo $row['pic']; ?>" alt="" width="50px" height="50px">
            </div>
            <div class="form-group">
                <label>标题:</label>
            ...
            <div class="form-group">
                <label>开始时间:</label>
                <input type="date" class="form-control" name="start_time" value="<?php echo $row['start_time']; ?>"/>
            </div>
            <div class="form-group">
                <label>结束时间:</label>
                <input type="date" class="form-control" name="end_time" value="<?php echo $row['end_time']; ?>"/>
            </div>
            <div class="form-group">
                <label>发布:</label><input type="radio"  name="status" value="1" <?=$row['status']==1?'checked':''?>/>
                <label>不发布:</label><input type="radio"  name="status" value="2" <?=$row['status']==2?'checked':''?>/>
            </div>
            <!--<div class="form-group">-->
            ...
            <!--</div>-->
            <div class="form-group">
                <button class="btn btn-primary onlineBtn">确认修改</button>
            </div>
        </form>
    </div>
</div>
