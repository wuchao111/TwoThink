...
<head>
    ...
    <link href="static/home/css1/style.css" rel="stylesheet">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('edit'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>标题:</label>
                <input type="text" class="form-control" name="title" value="<?php echo $row['0']['title']; ?>"/>
            </div>
            <div class="form-group">
                <label>图片:</label>
                <input type="file" class="form-control" name="pic" />
                <img src="<?php echo $row['0']['pic']; ?>" alt="" width="50px" height="50px">
            </div>
            <div class="form-group">
                <label>内容:</label>
                <input type="text" class="form-control" name="intro" value="<?php echo $row['0']['intro']; ?>"/>
            </div>
